// Generado automáticamente por twoslash-cli de IndexGetStarted2.js.md
...
<div class='twoslash-annotation left' style="top: 1.3rem">
  ...
  <p class='twoslash-annotation-text' style="transform: rotate(-3deg)">Agregar esto a un archivo JS muestra errores en tu editor</p>
</div>
<div class='twoslash-annotation right' style="top: 5.7rem">
  ...
  <p class='twoslash-annotation-text' style="transform: rotate(3deg)">¡el parámetro es arr, no orr!</p>
</div></div>
`
