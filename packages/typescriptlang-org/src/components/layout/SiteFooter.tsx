...
const popularPages = [
  {
    ...
    description: "Todos los tipos comunes en TypeScript",
  },
  {
    title: "Crear tipos a partir de tipos",
    url: "/docs/handbook/2/types-from-types.html",
    description: "Técnicas para hacer tipos más elegantes",
  },
  {
    title: "Más sobre funciones",
    url: "/docs/handbook/2/functions.html",
    description: "Cómo proporcionar tipos a funciones en JavaScript",
  },
  {
    title: "Más sobre objetos",
    url: "/docs/handbook/2/objects.html",
    description: "Cómo proporcionar una forma de tipo a los objetos JavaScript",
  },
  {
    title: "Reducción",
    url: "/docs/handbook/2/narrowing.html",
    description: "Cómo infiere TypeScript tipos basados ​​en el comportamiento del entorno de ejecución",
  },
  {
    title: "Declaración de Variables",
    url: "/docs/handbook/variable-declarations.html",
    description: "Cómo crear y escribir variables  JavaScript",
  },
  {
    title: "TypeScript en 5 minutos",
    url: "/docs/handbook/typescript-in-5-minutes.html",
    description: "Una descripción general de la creación de una aplicación web con TypeScript",
  },
  {
    title: "Opciones TSConfig",
    url: "/tsconfig",
    description: "Todas las opciones de configuración de un proyecto",
  },
  {
    title: "Clases",
    url: "/docs/handbook/2/classes.html",
    description: "Cómo proporcionar tipos a las clases de JavaScript ES6",
  },
]
...
export const SiteFooter = (props: Props) => {
  ...
  return (
    <footer id="site-footer" role="contentinfo">
      ...
      {hideDocs ? null  :
        <section id="popular">
          <h3>Páginas de documentación populares</h3>
          <ul>
      ...
      <section id="community">
        <article id="logos">
          ...
          <p>Hecho con &#9829; en Redmond, Boston, San Francisco y Dublín</p>
          ...
          <p>
            ...
            <a
              ...
              title="Política de privacidad de Microsoft"
            >
              Privacidad
            </a>
          </p>
