      ...
      <Layout title="Desarrolladores - Complementos de Playground" description="¿Qué es un complemento TypeScript de Playground y cómo puedes crear uno?" lang="es">
        <div id="dev">
          ...
          <div className="raised main-content-block">
            ...
            <p><b>Paso 3</b>: Abre el <a href={withPrefix("/play/")}>playground</a> en tu navegador, haz clic en "Opciones" y habilita <code>"Conectar a localhost:5000/index.js"</code></p>
