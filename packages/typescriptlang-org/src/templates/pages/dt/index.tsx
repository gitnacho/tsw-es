...
const DTIndex: React.FC<Props> = (props) => {
  ...
  return (
    <Layout title="¿Qué es definitivamente tipificado?" description="Definitivamente tipificado proporciona información de tipo para miles de bibliotecas de JavaScript." lang={props.pageContext.lang} suppressCustomization>
      <div id="dt">
        <Section color="darkblue">
          ...
          <h1>Definitivamente tipificado</h1>
          <h2>Proporciona información de tipo para miles de bibliotecas JavaScript.</h2>
        </Section>
        <Section color="white">
          <a className="dt-info-button" href="#" style={{ opacity: "0.2", pointerEvents: "none" }} aria-hidden="true" tabIndex={-1}>
            <div aria-hidden="true" className="above"><p tabIndex={-1} aria-hidden="true">Aprende</p></div>
            <div aria-hidden="true" className="below"><p tabIndex={-1} aria-hidden="true">¿Qué es<br />Definitivamente tipificado?</p></div>
          </a>

          <a className="dt-info-button" href="/dt/search">
            <div className="above"><p>Búsqueda de tipo</p></div>
            <div className="below"><p>Buscar bibliotecas<br />con tipos</p></div>
          </a>

          <a className="dt-info-button" href="https://github.com/definitelytyped/definitelytyped/#definitely-typed">
            <div className="above"><p>Contribuye</p></div>
            <div className="below"><p>Ayuda a mejorar<br />¿Definitivamente tipificado?</p></div>
          </a>
        </Section>
      </div>
    </Layout >
