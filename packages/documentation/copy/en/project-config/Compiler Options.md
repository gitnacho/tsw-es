...
<!-- Comienzo del reemplazo --><h3>CLI Commands</h3>
<table class="cli-option" width="100%">
  <thead>
    <tr>
      <th>Bandera</th>
...
<tr class="option-description even"><td colspan="3">
<p>Eliminar el resultado de todos los proyectos.</p>
</td></tr>
...
<tr class="option-description even"><td colspan="3">
<p>Elimina una lista de archivos del procesamiento del modo de observación.</p>
</td></tr>
...
<tr class="option-description even"><td colspan="3">
<p>Llama sincrónicamente a las devoluciones de llamada y actualiza el estado de los observadores de directorios en plataformas que no admiten la visualización recursiva de forma nativa.</p>
</td></tr>
...
<tr class="option-description even"><td colspan="3">
<p>Especifica cómo se ven los directorios en los sistemas que carecen de la funcionalidad de observación recursiva de archivos.</p>
</td></tr>
...
<tr class="option-description odd"><td colspan="3">
<p>Especifica cómo funciona el modo de observación de TypeScript.</p>
</td></tr>
...
<tr class="option-description odd"><td colspan="3">
<p>Permite que los archivos JavaScript formen parte de tu programa. Utiliza la opción <code>checkJS</code> para obtener errores de estos archivos.</p>
</td></tr>
...
</li><li><p><code>false</code> de otra manera.</p>
</li></ul></td>
</tr>
<tr class="option-description even"><td colspan="3">
<p>Permite 'import x from y' cuando un módulo no tiene una 'export' predeterminada.</p>
</td></tr>
...
<tr class="option-description odd"><td colspan="3">
<p>Permitir acceder a global a UMD desde módulos.</p>
</td></tr>
...
<tr class="option-description even"><td colspan="3">
<p>Deshabilita el informe de errores para el código inalcanzable.</p>
</td></tr>
...
<tr class="option-description odd"><td colspan="3">
<p>Deshabilita el informe de errores para las etiquetas no utilizadas.</p>
</td></tr>
...
<tr class="option-description odd"><td colspan="3">
<p>Tener recompilaciones en proyectos que usan <a href="#incremental"><code>incremental</code></a> y el modo <code>watch</code> suponen que los cambios dentro de un archivo solo afectarán a los archivos que dependan directamente de él.</p>
</td></tr>
...
<tr class="option-description odd"><td colspan="3">
<p>Ya no es compatible. En versiones anteriores, configura manualmente la codificación de texto para leer archivos.</p>
</td></tr>
...
<tr class="option-description even"><td colspan="3">
<p>Habilita el informe de errores en la comprobación de tipo de archivos JavaScript.</p>
</td></tr>
...
<tr class="option-description odd"><td colspan="3">
<p>Habilita las restricciones que permiten utilizar un proyecto de TypeScript con referencias de proyecto.</p>
</td></tr>
...
<tr class="option-description even"><td colspan="3">
<p>Genera archivos .d.ts a partir de archivos TypeScript y JavaScript en su proyecto.</p>
</td></tr>
...
<tr class="option-description odd"><td colspan="3">
<p>Salida de información de rendimiento del compilador después de la construcción.</p>
</td></tr>
...
<tr class="option-description even"><td colspan="3">
<p>Reduce el número de proyectos cargados automáticamente por TypeScript.</p>
</td></tr>
...
<tr class="option-description odd"><td colspan="3">
<p>Elimina el límite de 20 MB en el tamaño total del código fuente para los archivos JavaScript en el servidor de lenguaje TypeScript.</p>
</td></tr>
...
<tr class="option-description even"><td colspan="3">
<p>Opta por excluir un proyecto de la comprobación de referencias multiproyecto al editarlo.</p>
</td></tr>
...
<tr class="option-description even"><td colspan="3">
<p>sólo produce archivos d.ts y no archivos JavaScript.</p>
</td></tr>
...
<tr class="option-description odd"><td colspan="3">
<p>Interpreta los tipos de propiedad opcionales tal como están escritos, en lugar de agregar 'undefined'.</p>
</td></tr>
...
<tr class="option-description even"><td colspan="3">
<p>Habilita el soporte experimental para decoradores de borrador TC39 etapa 2.</p>
</td></tr>
...
<tr class="option-description odd"><td colspan="3">
<p>Imprime los archivos leídos durante la compilación, incluido el motivo por el que se incluyeron.</p>
</td></tr>
...
<tr class="option-description even"><td colspan="3">
<p>Genera información más detallada sobre el rendimiento del compilador después de la compilación.</p>
</td></tr>
...
<tr class="option-description odd"><td colspan="3">
<p>Asegúrate de que la carcasa sea la correcta en las importaciones.</p>
</td></tr>
...
<tr class="option-description even"><td colspan="3">
<p>Emite un perfil de CPU v8 del compilador ejecutado para depuración.</p>
</td></tr>
...
<tr class="option-description odd"><td colspan="3">
<p>Permite importar funciones auxiliares desde 'tslib' una vez por proyecto, en lugar de incluirlas por archivo.</p>
</td></tr>
...
<tr class="option-description odd"><td colspan="3">
<p>Guarda los archivos <code>.tsbuildinfo</code> para permitir la compilación incremental de proyectos.</p>
</td></tr>
...
<tr class="option-description even"><td colspan="3">
<p>Incluir archivos de mapas fuente dentro del JavaScript emitido.</p>
</td></tr>
...
<tr class="option-description odd"><td colspan="3">
<p>Incluye el código fuente en los mapas fuente dentro del JavaScript emitido.</p>
</td></tr>
...
<tr class="option-description even"><td colspan="3">
<p>Se asegura de que cada archivo se pueda transpilar de forma segura sin depender de otras importaciones.</p>
</td></tr>
...
<tr class="option-description even"><td colspan="3">
<p>Especifica la función de fábrica JSX que se utiliza al apuntar a React JSX emit, por ejemplo, 'React.createElement' o 'h'.</p>
</td></tr>
...
<tr class="option-description odd"><td colspan="3">
<p>Especifica la referencia de fragmento JSX utilizada para los fragmentos al apuntar a la emisión de React JSX, por ejemplo, 'React.Fragment' o 'Fragment'.</p>
</td></tr>
...
<tr class="option-description even"><td colspan="3">
<p>Especifica el especificador de módulo utilizado para importar las funciones de fábrica JSX cuando se usa <code>jsx: react-jsx*</code>.</p>
</td></tr>
...
<tr class="option-description even"><td colspan="3">
<p>Especifica un conjunto de archivos de declaración de biblioteca empaquetados que describen el entorno de ejecución destino.</p>
</td></tr>
...
<tr class="option-description odd"><td colspan="3">
<p>Especifica la ubicación donde el depurador debe encontrar los archivos de mapa en lugar de las ubicaciones generadas.</p>
</td></tr>
...
<tr class="option-description even"><td colspan="3">
<p>Especifica la profundidad máxima del directorio utilizado para comprobar archivos JavaScript de <code>node_modules</code>. Solo aplicable con <a href="#allowJs"><code>allowJs</code></a>.</p>
</td></tr>
...
<tr class="option-description even"><td colspan="3">
<p>Controla qué método se usa para detectar si un archivo JS es un módulo.</p>
</td></tr>
...
<tr class="option-description odd"><td colspan="3">
<p>Especifica cómo busca <em>TypeScript</em> un archivo de un determinado especificador de módulo.</p>
</td></tr>
...
<tr class="option-description even"><td colspan="3">
<p>Desactiva la emisión de archivos de una compilación.</p>
</td></tr>
...
<tr class="option-description even"><td colspan="3">
<p>Deshabilita la emisión de archivos si se informa algún error de verificación de tipo.</p>
</td></tr>
...
<tr class="option-description even"><td colspan="3">
<p>Habilita el informe de errores para casos fallidos en declaraciones switch.</p>
</td></tr>
...
<tr class="option-description even"><td colspan="3">
<p>Se asegura de que la redefinición de miembros de las clases derivadas estén marcados con un modificador <code>override</code>.</p>
</td></tr>
...
<tr class="option-description odd"><td colspan="3">
<p>Habilita el reporte de errores para las rutas de código que explícitamente no tienen <code>return</code> en una función.</p>
</td></tr>
...
<tr class="option-description even"><td colspan="3">
<p>Habilita el reporte de errores cuando a <code>this</code> se le asigne el tipo <code>any</code>.</p>
</td></tr>
...
<tr class="option-description odd"><td colspan="3">
<p>Deshabilita la adición de directivas de 'use strict' en los archivos JavaScript emitidos.</p>
</td></tr>
...
<tr class="option-description even"><td colspan="3">
<p>Desactiva la inclusión de cualquier archivo de biblioteca, incluido el <code>lib.d.ts</code> predeterminado.</p>
</td></tr>
...
<tr class="option-description even"><td colspan="3">
<p>No permite que las <code>import</code>s, <code>require</code>s o <code>&#x3C;reference></code>s expandan el número de archivos que TypeScript debe agregar a un proyecto.</p>
</td></tr>
...
<tr class="option-description odd"><td colspan="3">
<p>Desactiva la comprobación estricta de firmas genéricas en tipos de <code>function</code>.</p>
</td></tr>
...
<tr class="option-description odd"><td colspan="3">
<p>Configuración obsoleta. En su lugar usa <a href="#outFile"><code>outFile</code></a>.</p>
</td></tr>
...
<tr class="option-description odd"><td colspan="3">
<p>Especifique un archivo que agrupe todas las salidas en un archivo JavaScript. Si <a href="#declaration"><code>declaration</code></a> es <code>true</code>, también designa un archivo que agrupa toda la salida <code>.d.ts</code>.</p>
</td></tr>
...
<tr class="option-description odd"><td colspan="3">
<p>Especifica una lista de complementos de servicios de idioma a incluir.</p>
</td></tr>
...
<tr class="option-description even"><td colspan="3">
<p>Desactiva el borrado de declaraciones <code>const enum</code> en el código generado.</p>
</td></tr>
...
<tr class="option-description odd"><td colspan="3">
<p>Desactiva la resolución de enlaces simbólicos a su ruta real. Esto se correlaciona con la misma bandera en el node.</p>
</td></tr>
...
<tr class="option-description even"><td colspan="3">
<p>Conserva los valores importados no utilizados en la salida de JavaScript que de otro modo se eliminarían.</p>
</td></tr>
...
<tr class="option-description odd"><td colspan="3">
<p>Especifica el objeto invocado para <code>createElement</code>. Esto solo se aplica al apuntar a la emisión JSX de <code>react</code>.</p>
</td></tr>
...
<tr class="option-description even"><td colspan="3">
<p>Desactivar la emisión de comentarios.</p>
</td></tr>
...
<tr class="option-description even"><td colspan="3">
<p>Omite la comprobación de tipos de archivos <code>.d.ts</code> que se incluyen con TypeScript.</p>
</td></tr>
...
<tr class="option-description odd"><td colspan="3">
<p>Omite la comprobación de tipo de todos los archivos <code>.d.ts</code>.</p>
</td></tr>
...
<tr class="option-description even"><td colspan="3">
<p>Habilita todas las opciones de verificación estricta de tipo.</p>
</td></tr>
...
<tr class="option-description even"><td colspan="3">
<p>Al asignar funciones, verifica que los parámetros y los valores devueltos sean compatibles con el subtipo.</p>
</td></tr>
...
<tr class="option-description odd"><td colspan="3">
<p>Cuando la comprobación de tipo, tenga en cuenta <code>null</code> y <code>undefined</code>.</p>
</td></tr>
...
<tr class="option-description even"><td colspan="3">
<p>Comprueba las propiedades de la clase que están declaradas pero no establecidas en el constructor.</p>
</td></tr>
...
<tr class="option-description odd"><td colspan="3">
<p>Deshabilita la emisión de declaraciones que tengan <code>@internal</code> en sus comentarios JSDoc.</p>
</td></tr>
...
<tr class="option-description even"><td colspan="3">
<p>Deshabilita la notificación de errores de propiedad en exceso durante la creación de literales de objeto.</p>
</td></tr>
...
<tr class="option-description odd"><td colspan="3">
<p>Suprime los errores <code>noImplicitAny</code> al indexar objetos que carecen de índice de firmas.</p>
</td></tr>
...
<tr class="option-description even"><td colspan="3">
<p>Establece la versión de lenguaje JavaScript para JavaScript emitido e incluye declaraciones de biblioteca compatibles.</p>
</td></tr>
...
<tr class="option-description odd"><td colspan="3">
<p>Rutas de registro utilizadas durante el proceso <a href="#moduleResolution"><code>moduleResolution</code></a>.</p>
</td></tr>
...
<tr class="option-description even"><td colspan="3">
<p>Especifica el directorio para los archivos de compilación incremental <code>.tsbuildinfo</code>.</p>
</td></tr>
...
<tr class="option-description odd"><td colspan="3">
<p>Emitir campos de clase compatibles con el estándar ECMAScript.</p>
</td></tr>
...
<tr class="option-description even"><td colspan="3">
<p>Variables predeterminadas de la cláusula <code>catch</code> como <code>unknown</code> en lugar de <code>any</code>.</p>
</td></tr>

</tbody></table>
<!-- Fin del reemplazo -->undefined