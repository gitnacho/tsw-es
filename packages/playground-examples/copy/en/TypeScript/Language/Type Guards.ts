...
// Para ejecutar estos ejemplos, crearemos algunas clases, aquí hay un
// sistema para manejar pedidos por Internet o por teléfono.
...
// Luego, un tipo  que podría ser uno  de los dos subtipos  de Order o
// undefined
...
// clave  está  en  el  objeto  para reducir  la  unión.  ("in"  is  a
// JavaScript operador para probar claves de objeto.)

if ("email" in possibleOrder) {
  const mustBeInternetOrder = possibleOrder;
}

// Puedes utilizar  el operador  "instanceof" de JavaScript  si tienes
// una clase que se ajuste a la interfaz:
...
// Puedes utilizar el operador "typeof"  de JavaScript para reducir tu
// unión. Esto  solo funciona  con primitivos inside  JavaScript (like
...
// Puedes ver  una lista completa  de posibles tipos de  valores aquí:
//   https://developer.mozilla.org/es/docs/Web/JavaScript/Reference/Operators/typeof

// El uso de  operadores de JavaScript solo puede  llegar hasta cierto
// punto. Cuando deseas verificar tus propios tipos de  objetos puedes
// usar la función de predicado type.

// Una función de predicado type es una función donde el tipo devuelto
// ofrece información al análisis de flujo de código cuando la función
// devuelve true.

// Al  utilizar  la  posible  orden, podemos  utilizar  dos  tipos  de
// protectores   para declarar de qué tipo es possibleOrder:
