...
// Al cargar un ejemplo, ocasionalmente verás una e=[número]
// que se utiliza para garantizar que el navegador se vuelva a cargar correctamente cuando
// saltas entre ejemplos. Es inofensivo.

// Puedes ver el cambio de URL en esta página editando algunos
// de los comentarios, o comienza a seleccionar algún texto. Al presionar
// recargar en tu navegador to llevará de vuelta al mismo
// estado.
