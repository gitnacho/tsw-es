// Este es un montón de los archivos .d.ts de typescript generados importados
// en un solo archivo para que el trabajador sepa con qué está trabajando.
...
export namespace worker {
    ...
    export interface IWorkerContext<H = undefined> {
        /**
         * Un proxy al objeto host del hilo principal.
         */
        host: H
        /**
         * Obtiene todos los modelos de espejo disponibles en este trabajador.
         */
